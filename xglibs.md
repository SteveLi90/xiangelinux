...
<h2>4.3 下载软件包</h2>
只需要修改$SRC_URI 为测试工程的下载地址<a href='http://xiangelinux.googlecode.com/files/test-1.0.0.tar.bz2'>http://xiangelinux.googlecode.com/files/test-1.0.0.tar.bz2</a>.<br>
